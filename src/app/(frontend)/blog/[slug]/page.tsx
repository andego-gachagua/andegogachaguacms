        ...
        <div className="bg-white rounded-2xl shadow-xl -mt-32 lg:-mt-36 overflow-hidden relative z-10">
          ...
          <div className="p-6 md:p-10 lg:p-12 pb-6">
            ...
            <div className="flex items-center mt-6 pb-6 border-b">
              <div className="h-12 w-12 rounded-full bg-[#cb8547]/10 flex items-center justify-center text-[#cb8547] font-bold text-xl">
          ...
          <div className="bg-gray-50 p-6 md:p-10">
            <div className="flex items-center">
              <div className="h-14 w-14 rounded-full bg-[#cb8547]/10 flex items-center justify-center text-[#cb8547] font-bold text-xl">
                {post.author ? post.author.charAt(0).toUpperCase() : 'U'}
              </div>
              <div className="ml-4">
                <div className="font-medium text-gray-900">{post.author || 'Unknown Author'}</div>
