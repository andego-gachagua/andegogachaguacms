    ...
    <footer className="bg-[#f0f1f0] px-6 py-12 md:py-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4 mb-12">
          ...
          {/* Social Media */}
          <div>
            <h3 className="font-semibold text-[#cb8547] mb-4 text-lg">Connect With Us</h3>
            ...
            <p className="text-gray-700 text-sm">
              Connect with us on social media to stay updated on the latest legal news, insights,
              and our firm{"'"}s activities.
            </p>
          </div>
        </div>
